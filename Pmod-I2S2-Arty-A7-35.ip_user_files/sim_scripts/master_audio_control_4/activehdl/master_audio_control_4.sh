...
#                script (type 'master_audio_control_4.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/ZachKrueger/Documents/AI/guitar-pedal/Pmod-I2S2-Arty-A7-35.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
