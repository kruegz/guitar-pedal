...
#
# Script generated by Vivado on Thu Feb 20 15:40:43 -0600 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : master_audio_control_4.sh
...
#
# Usage        : master_audio_control_4.sh
#                master_audio_control_4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                master_audio_control_4.sh [-reset_run]
#                master_audio_control_4.sh [-reset_log]
#                master_audio_control_4.sh [-help]
#
...
# script info
echo -e "master_audio_control_4.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./master_audio_control_4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2 -L uvm -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_6 -L mult_gen_v12_0_22 -L floating_point_v7_1_19 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot master_audio_control_4 xil_defaultlib.master_audio_control_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim master_audio_control_4 -key {Behavioral:sim_3:Functional:master_audio_control_4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb master_audio_control_4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./master_audio_control_4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: master_audio_control_4.sh [-help]\n\
Usage: master_audio_control_4.sh [-step]\n\
Usage: master_audio_control_4.sh [-lib_map_path]\n\
Usage: master_audio_control_4.sh [-reset_run]\n\
Usage: master_audio_control_4.sh [-reset_log]\n\
Usage: master_audio_control_4.sh [-keep_index]\n\
Usage: master_audio_control_4.sh [-noclean_files]\n\n\
