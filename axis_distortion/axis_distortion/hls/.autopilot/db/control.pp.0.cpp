...
__attribute__((sdx_kernel("master_audio_control", 0))) void master_audio_control(hls::stream<axis_sample> &in,
...
__attribute__((sdx_kernel("master_audio_control", 0))) void master_audio_control(hls::stream<axis_sample> &in, hls::stream<axis_sample> &out,
                          bool enable_distortion, bool enable_echo, bool enable_eq, int hard_clip_level,
                          int gain_low, int gain_mid, int gain_high) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=master_audio_control
# 8 "control.cpp"
