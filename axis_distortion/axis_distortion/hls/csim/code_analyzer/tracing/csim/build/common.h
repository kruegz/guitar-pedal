...
#define HARD_CLIP_LEVEL  4000000  // Threshold for hard clipping
...
void master_audio_control(hls::stream<axis_sample> &in, hls::stream<axis_sample> &out, bool enable_distortion, bool enable_echo, bool enable_eq);
